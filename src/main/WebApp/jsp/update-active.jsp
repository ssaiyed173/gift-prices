...
<nav class="navbar navbar-default" style="color: cyan !important">
  <div class="container-fluid">
	...
	<div class="container">
		<div class="row">
			<form action="update-active" method="post">
				<div class="form-group">
					<label for="id">Show id: </label>
					<input type="text" class="form-control" name="id" value="${show.id }" readonly />
				</div> 
				<div class="form-group">
				...
				<div class="form-group">
					Is Active <br />
					<label>
						<input type="radio" name="active" value="Yes" ${show.active.equals("Yes") ? 'checked':'' } /> Yes
					</label>
					<label>
						<input type="radio" name="active" value="No"  ${show.active.equals("No") ? 'checked':'' }  /> No
					</label>
				</div>
